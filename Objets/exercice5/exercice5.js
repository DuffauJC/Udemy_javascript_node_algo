...
var parc = require("./parc/gestionVoitures");
...
while(choix !== 0){
    ...
    switch(choix){
        case 1 : parc.afficherParc();
        break;
        case 2 : parc.afficherVoitures()
        break;
        case 3 : parc.modifParc();
        break;
        case 4 : 
            var modele = readline.question("Quel modele voulez-vous supprimer ? ")
